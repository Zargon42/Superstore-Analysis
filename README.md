...
Portfolio project using SQL (SQLite) and PowerBI to analyse the [Sample Superstore Dataset](https://powerbidocs.com/2019/11/28/power-bi-sample-data-set-for-practice/). The goal was to take raw sales data and convert it into clear insights, answering business questions.
...
### Power BI
Cleaned data table was immported into PowerBI for visualisation.
- 5 charts produced corresponding to each of the buisness
  - Revenue and profit by Sub-Category, with drill down to product name
  - Profit by country with drill down -> State -> City
  - Profit over time
